...
<title>Auri -- O Assistente de Voz que Realmente Pensa | para Alexa</title>
    ...
    com AI assistant AI. Analise de negocios, decisoes estrategicas e memoria real.">
    ...
    com raciocinio real. Powered by an AI assistant.">
...
High Intent (converter):
    ...
    - "como usar assistente de IA no alexa"
...
skill_name: "Auri -- IA de Voz Inteligente"
    ...
    short_description: >
      ...
      Powered by an AI assistant -- pensa, recorda e evolui com voce.
    ...
    keywords: "ia, inteligencia artificial, assistente inteligente, assistente de IA, negocios"
