...
5. Rename the extracted folder from `super-product-business-finance-main` to `super-product-business-finance`.
6. Copy the renamed `super-product-business-finance` folder into your agent's skills directory.
...
This repository is the `super-product-business-finance` skill. Keep the full `super-product-business-finance` folder together when installing it.
